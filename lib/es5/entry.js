  ...
  (0, _createClass3.default)(Entry, null, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(id, data) {
        ...
        var clock = arguments[3];
        var nodeId = arguments[4];
        var identity = arguments[5];
        var ipfs = arguments[6];
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                clockId = clock ? clock.id : nodeId ? nodeId : id;
                ...
                _context.next = 17;
                return identity.provider.sign(encode(entry));
      ...
      function createAndPublish(_x2, _x3) {
    ...
    key: 'verify',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(identity, entry) {
        var e;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                throw new Error("Identity is required, cannot verify entry");
              ...
              case 8:
                ...
                return _context2.abrupt('return', identity.provider.verify(entry.sig, entry.key, encode(e)));
