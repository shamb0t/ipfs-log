...
var EntryValidator = require('./validator');
...
var Log = function (_GSet) {
   ...
   * @return {Log}                            Log
   */
  function Log(ipfs, id, entries, heads, clock, sign, verify, publicKey) {
    ...
    // Integrity checker
    _this._entryValidator = new EntryValidator(sign, verify, publicKey);
    ...
    var clockId = _this._entryValidator ? _this._entryValidator.publicKey : _this._id;
  ...
  (0, _createClass3.default)(Log, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return Entry.create(this._storage, this._entryValidator, this.id, data, nexts, this.clock);
    ...
    key: 'join',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(log) {
        var _this3 = this;

        var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
        var newItems, verify, addToNextsIndex, tmp, notReferencedByNewItems, notInCurrentNexts, nextsFromNewItems, mergedHeads, maxClock;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                    ...
                    return _regenerator2.default.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return Entry.verify(entry, _this3._entryValidator);
                ...
                _context3.next = 9;
                return pMap((0, _values2.default)(newItems), verify, { concurrency: 1 });
    ...
    value: function fromMultihash(ipfs, hash) {
      ...
      var entryValidator = arguments[4];
      ...
      return LogIO.fromMultihash(ipfs, hash, length, exclude, onProgressCallback).then(function (data) {
        return new Log(ipfs, data.id, data.values, data.heads, data.clock, entryValidator.sign, entryValidator.verify, entryValidator.publicKey);
      });
    }
    ...
    value: function fromEntryHash(ipfs, hash, id) {
      ...
      var entryValidator = arguments[5];
      ...
      return LogIO.fromEntryHash(ipfs, hash, id, length, exclude, onProgressCallback).then(function (data) {
        return new Log(ipfs, id, data.values, null, null, entryValidator.sign, entryValidator.verify, entryValidator.publicKey);
      });
    }
    ...
    value: function fromJSON(ipfs, json) {
      var length = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -1;
      var entryValidator = arguments[3];
      ...
      return LogIO.fromJSON(ipfs, json, length, timeout, onProgressCallback).then(function (data) {
        return new Log(ipfs, data.id, data.values, null, null, entryValidator.sign, entryValidator.verify, entryValidator.publicKey);
      });
    }
    ...
    value: function fromEntry(ipfs, sourceEntries) {
      ...
      return LogIO.fromEntry(ipfs, sourceEntries, length, exclude, onProgressCallback).then(function (data) {
        return new Log(ipfs, data.id, data.values, null, null, null, null, null);
      }); // entryValidator.sign, entryValidator.verify, entryValidator.publicKey))
    }
